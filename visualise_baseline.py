...
# Standardise before PCA: the raw volume features are orders of magnitude
# larger than the ratio features and would otherwise dominate PC1 entirely.
# (Detection itself is fit on unscaled X; Isolation Forest is scale-invariant.)
